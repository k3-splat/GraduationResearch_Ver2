...
class bPC_SNN(nn.Module):
    ...
    def manual_weight_update(self, x_data, idx, y_target=None):
        """
        ST-LRA Update Rule
        """
        alpha_u_list = self.config['alpha_u_list']
        ...
        for i in range(len(self.layers)):
            ...
            if i < len(self.layers) - 1:
                ...
                self.V[i] += alpha_u_list[idx] * grad_V
            ...
            if i > 0:
                ...
                if i == len(self.layers) - 1:
                    if y_target is not None:
                        ...
                        self.W[i-1] += alpha_u_list[idx] * grad_W
                else:
                    s_own = self.layers[i].s
        ...
        for epoch in range(CONFIG['epochs']):
            ...
            for batch_idx, (imgs, lbls) in enumerate(train_l):
                ...
                for t in range(steps):
                    ...
                    model.manual_weight_update(x_data=x_t, idx=alpha_u, y_target=targets)
